000\000\000"
val gotoT =
"\
\\001\000\002\000\002\000\089\000\004\000\001\000\000\000\
\\000\000\
\\000\000\
\\000\000\
...
\\001\000\032\000\004\000\001\000\005\000\031\000\000\000\
\\000\000\
\\000\000\
\\000\000\
...
\\001\000\057\000\003\000\056\000\004\000\001\000\000\000\
\\000\000\
\\000\000\
\\000\000\
\\000\000\
...
\\000\000\
\\000\000\
\\001\000\032\000\004\000\001\000\005\000\058\000\000\000\
\\000\000\
\\000\000\
\\000\000\
...
\\000\000\
\\000\000\
\\001\000\063\000\004\000\001\000\000\000\
\\000\000\
\\000\000\
\\000\000\
\\000\000\
\\000\000\
\\009\000\070\000\010\000\069\000\000\000\
\\000\000\
\\006\000\073\000\000\000\
\\000\000\
\\001\000\074\000\004\000\001\000\000\000\
\\000\000\
\\000\000\
\\000\000\
\\000\000\
...
\\000\000\
\\001\000\080\000\004\000\001\000\000\000\
\\000\000\
\\000\000\
\\001\000\081\000\004\000\001\000\000\000\
\\000\000\
\\000\000\
...
\\000\000\
\\000\000\
\\001\000\088\000\004\000\001\000\000\000\
\\000\000\
\\000\000\
\"
val numstates = 90
...
datatype svalue = VOID | ntVOID of unit ->  unit
 ...
 | ID of unit ->  (string) | typefieldsList of unit ->  (A.field list)
 | typefields of unit ->  (A.field list)
 | typefield of unit ->  (A.field) | dec of unit ->  (A.dec)
 | declist of unit ->  (A.dec list)
 | listseq of unit ->  ( ( A.exp * pos )  list)
 | expseq of unit ->  (A.exp list) | lvalue of unit ->  (A.var)
 | explist of unit ->  (A.exp list) | program of unit ->  (A.exp)
 | exp of unit ->  (A.exp)
end
...
|  ( 27, ( ( _, ( MlyValue.ID ID2, ID2left, ID2right)) :: _ :: ( _, ( 
...
, (FUNCTIONleft as FUNCTION1left), _)) :: rest671)) => let val  result
 ...
 val  (exp as exp1) = exp1 ()
 in (
{name= Symbol.symbol ID1, params= typeFields, result= SOME (Symbol.symbol ID2, ID2left), body= exp, pos=FUNCTIONleft}
)
end)
...
|  ( 31, ( ( _, ( MlyValue.listseq listseq1, _, listseq1right)) :: ( _
, ( MlyValue.exp exp1, (expleft as exp1left), _)) :: rest671)) => let
 val  result = MlyValue.expseq (fn _ => let val  (exp as exp1) = exp1
 ()
 val  (listseq as listseq1) = listseq1 ()
 in ((exp, expleft) :: listseq)
end)
 in ( LrTable.NT 4, ( result, exp1left, listseq1right), rest671)
end
|  ( 32, ( rest671)) => let val  result = MlyValue.listseq (fn _ => (
nil))
 in ( LrTable.NT 5, ( result, defaultPos, defaultPos), rest671)
end
|  ( 33, ( ( _, ( MlyValue.listseq listseq1, _, listseq1right)) :: ( _
, ( MlyValue.exp exp1, expleft, _)) :: ( _, ( _, SEMICOLON1left, _))
 :: rest671)) => let val  result = MlyValue.listseq (fn _ => let val 
 (exp as exp1) = exp1 ()
 val  (listseq as listseq1) = listseq1 ()
 in ((exp,expleft) :: listseq)
end)
 in ( LrTable.NT 5, ( result, SEMICOLON1left, listseq1right), rest671)
...
|  ( 38, ( rest671)) => let val  result = MlyValue.typefields (fn _ =>
 (nil))
 in ( LrTable.NT 9, ( result, defaultPos, defaultPos), rest671)
end
|  ( 39, ( ( _, ( MlyValue.typefieldsList typefieldsList1, _, 
typefieldsList1right)) :: ( _, ( MlyValue.typefield typefield1, 
typefield1left, _)) :: rest671)) => let val  result = 
MlyValue.typefields (fn _ => let val  (typefield as typefield1) = 
typefield1 ()
 val  (typefieldsList as typefieldsList1) = typefieldsList1 ()
 in (typefield :: typefieldsList)
end)
 in ( LrTable.NT 9, ( result, typefield1left, typefieldsList1right), 
rest671)
end
|  ( 40, ( rest671)) => let val  result = MlyValue.typefieldsList (fn
 _ => (nil))
 in ( LrTable.NT 10, ( result, defaultPos, defaultPos), rest671)
end
|  ( 41, ( ( _, ( MlyValue.typefieldsList typefieldsList1, _, 
typefieldsList1right)) :: ( _, ( MlyValue.typefield typefield1, _, _))
 :: ( _, ( _, COMMA1left, _)) :: rest671)) => let val  result = 
MlyValue.typefieldsList (fn _ => let val  (typefield as typefield1) = 
typefield1 ()
 val  (typefieldsList as typefieldsList1) = typefieldsList1 ()
 in (typefield :: typefieldsList)
end)
 in ( LrTable.NT 10, ( result, COMMA1left, typefieldsList1right), 
rest671)
end
